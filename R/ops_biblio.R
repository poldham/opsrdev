#' @title Process Multiple Lists of OPS Bibliographic Data (formerly ops_multi_biblio)
#'
...
#'   a single list containing 10 list objects each containing 100 records.
...
#'   `ipc` column for the historic IPC7 classification is presently dropped where present.
...
#' @export
#' @examples \dontrun{ops_biblio(ops_biblios)}
...
# there is more than one possibility for the field names here... so will need an if based on criteria. The difference is the presence of cited
